...
public class PolishingStationMenu extends AbstractContainerMenu {
    ...
    public PolishingStationMenu(int containerId, Inventory playerInventory, Container container, ContainerData data) {
        ...
        // 入力スロット（鍛造素材） - 位置 (56, 17)
        this.addSlot(new InputSlot(container, PolishingStationBlockEntity.SLOT_INPUT, 56, 17));

        // 研磨剤スロット - 位置 (56, 53)
        this.addSlot(new AgentSlot(container, PolishingStationBlockEntity.SLOT_AGENT, 56, 53));

        // 出力スロット - 位置 (116, 35)
        this.addSlot(new OutputSlot(container, PolishingStationBlockEntity.SLOT_OUTPUT, 116, 35));
